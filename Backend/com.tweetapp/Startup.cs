using com.tweetapp.ApacheKafka.ApacheKafkaProducer;
...
namespace com.tweetapp
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IApacheKafkaProducer, ApacheKafkaProducer>();
            ...
            services.AddSwaggerGen(options => {
                options.SwaggerDoc("com.tweetapp", new Microsoft.OpenApi.Models.OpenApiInfo
                {
                    Title = "Tweet App API",
                    Version = "1.0"
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(options => {
                options.SwaggerEndpoint("/swagger/com.tweetapp/swagger.json", "Tweet App API");
                options.RoutePrefix = "";
            });
